...
const Pedidos = () => {
  ...
  return (
    <PaperProvider>
      <Block>
        <Block>
          <Text flex style={{paddingLeft: 10, paddingTop: 5, fontSize: 18, fontWeight: 'bold'}} color={argonTheme.COLORS.BLACK}>Pedidos</Text>
        </Block>
        <Block row space="evenly">
          ...
          <Block flex center>
            <Button small center disabled={buttomState} color="black" style={styles.optionsButton} onPress={() => navigation.navigate("Editar pedido", checked)}>
